...
# Generating an _Endpoint_

### Tutorial Video

Below is a video showing you to use the `xx new` command to create an endpoint and more
...
<div>
  ...
  <iframe
    ...
    src={"https://www.youtube.com/embed/KSjx4ktEb54?si=5K5ADz8gvZ2iaoG_"}
    frameBorder="0"
